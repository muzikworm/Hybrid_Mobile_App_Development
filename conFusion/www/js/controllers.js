...
.filter('favoriteFilter', function () {
    return function (dishes, favorites) {
        ...
        .controller('DishDetailController', ['$scope', '$stateParams', 'menuFactory','dish','favoriteFactory','baseURL', '$ionicModal','$ionicPopover', '$timeout', '$ionicListDelegate',function($scope, $stateParams, menuFactory,dish,favoriteFactory,baseURL, $ionicModal,$ionicPopover,$timeout, $ionicListDelegate) {
           $scope.baseURL = baseURL;
            $scope.dish = {};
